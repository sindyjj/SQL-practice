...
--substr(자를 문자열, 시작 인덱스 길이), concat(문자연결)
...
SELECT LTRIM('javascript_java','java') FROM dual;--결과값:script_java
SELECT RTRIM('javascript_java','java') FROM dual;--결과값:javascript_
