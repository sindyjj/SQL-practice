...
CREATE TABLE dept2 (                                            
    -- PRIMARY = NULL(널 값) + UNIQUE(중복금지)
    dept_no NUMBER(2) CONSTRAINT dept2_deptno_pk PRIMARY KEY, 
    -- 구분을 할떄 중요한 것 :PRIMARY KEY
    dept_name VARCHAR2(14) NOT NULL CONSTRAINT dept2_deptname_uk UNIQUE, 
    -- NULL 값이 안들어가고 UNIQUE 중복금지
...
-- 왜래 키 (foreign key)가 부모테이블(참조테이블) 에 없다면 INSERT 불가능
INSERT INTO dept2
